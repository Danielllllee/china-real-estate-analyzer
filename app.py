...
hero_section(
    "中国房产估值与收益率分析系统",
    f"覆盖{len(config['cities'])}个城市的房产投资分析平台 | 区域均价数据来源：安居客/房天下/中国房价行情等平台",
)
...
features = [
    ("\U0001f3d9", "城市概览", "各区域真实二手房挂牌均价一览"),
    ("\U0001f4ca", "区域分析", "选择城市和区域，查看均价详情"),
    ("\U0001f9ee", "估值计算器", "待接入真实数据"),
    ("\U0001f4c8", "收益率分析", "待接入真实数据"),
    ("\U0001f30f", "城市对比", "多城市房价横向对比"),
]
