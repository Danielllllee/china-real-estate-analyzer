...
hero_section(
    "中国房产估值与收益率分析系统",
    f"覆盖{len(config['cities'])}个城市的房产投资分析平台 | 数据来源：安居客/房天下/中国房价行情/统计局等",
)
...
features = [
    ("\U0001f3d9", "城市概览", "各区域房价、租金、宏观数据一览"),
    ("\U0001f4ca", "区域分析", "选择城市和区域，查看均价与租金详情"),
    ("\U0001f9ee", "估值计算器", "基于真实租金的收益率法估值"),
    ("\U0001f4c8", "收益率分析", "各城市租金回报率对比排名"),
    ("\U0001f30f", "城市对比", "多城市房价、租金、经济数据对比"),
]
